 ...
 * </ul>
 * <p>
 * Also, value objects can be constructed from strings, optionally using a Locale with valueOf(String) and valueOf(String,Locale). The string may contain a decimal or floating point number followed by
 * optional whitespace followed by a unit (nothing for bytes, K for kilobyte, M for megabytes, G for gigabytes or T for terabytes) optionally followed by a B (for bytes). Any of these letters can be
 * any case. So, examples of permissible string values are:
 * <p>
 * <ul>
 * <li>37 (37 bytes)
 ...
 * <p>
 * The toString() methods is smart enough to convert a given value object to the most appropriate units for the given value.
...
public final class Bytes {
	 ...
	 */
	public static Bytes valueOf(final String string, final Locale locale) throws NumberFormatException {
